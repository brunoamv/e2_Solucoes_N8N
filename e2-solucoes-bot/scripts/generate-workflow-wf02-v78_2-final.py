#!/usr/bin/env python3
"""
Generate WF02 V78.2 FINAL - Switch Node v3 Conditions Structure
================================================================

CRITICAL FIX FROM V78.1.6:
- V78.1.6 PROBLEM: Used Switch v3.4+ structure (mode: "rules") incompatible with n8n 2.15.0
- Root Cause: Switch v3 uses "conditions" structure, NOT "mode/rules"
- V78.2 FIX: Use Switch v3.0 "conditions" structure from working examples ✅

n8n Switch Node v3.0 CORRECT structure:
- parameters.conditions.options ✅
- parameters.conditions.conditions[] array ✅
- NO "mode", NO "rules", NO "fallbackOutput" ✅
- Uses dataType/operation structure for conditions ✅

Reference: n8n/workflows/old/09_rdstation_webhook_handler.json (WORKING)

Date: 2026-04-13
Author: E2 Bot Development Team - V78.2 Conditions Structure Fix
Version: V78.2 FINAL
"""
...
OUTPUT_V78_2 = Path(__file__).parent.parent / "n8n" / "workflows" / "02_ai_agent_conversation_V78_2_FINAL.json"
...
def create_switch_node_v3_conditions(position, node_id=None):
    ...
    Based on working examples from n8n/workflows/old/09_rdstation_webhook_handler.json
    ...
    CRITICAL: Switch v3 uses 'conditions', NOT 'mode/rules'!
    """
    if node_id is None:
...
def setup_v78_2_connections(workflow, switch_node, http_node1, http_node2, existing_update_conv_node):
    """
    Setup V78.2 connection architecture.
    ...
    """
    print("\n🔗 Setting up V78.2 connection architecture...")
...
def generate_v78_2_final():
    """Generate V78.2 FINAL workflow with Switch v3 'conditions' structure."""

    print("=" * 80)
    print("GENERATE WF02 V78.2 FINAL - SWITCH NODE v3 CONDITIONS STRUCTURE")
    print("=" * 80)
    ...
    workflow["name"] = "02_ai_agent_conversation_V78_2_FINAL"
    ...
    print("\n📝 Creating nodes with CORRECT v3 structures...")

    # Switch Node v3 with 'conditions'
    ...
    print(f"   ✅ Switch Node: 'conditions' structure (v3.0 correct)")
    ...
    setup_v78_2_connections(workflow, switch_node, http_node1, http_node2, existing_update_conv)

    print(f"\n💾 Saving to: {OUTPUT_V78_2}")
    OUTPUT_V78_2.parent.mkdir(parents=True, exist_ok=True)

    with open(OUTPUT_V78_2, "w", encoding="utf-8") as f:
        json.dump(workflow, f, indent=2, ensure_ascii=False)

    print("\n" + "=" * 80)
    print("✅ V78.2 FINAL GENERATED SUCCESSFULLY!")
    print("=" * 80)
    ...
    print(f"\n🎯 V78.2 FINAL Features:")
    print("   1. ✅ Switch Node v3 'conditions' structure (CORRECT)")
    print("   2. ✅ HTTP Request v3 bodyParameters")
    print("   3. ✅ All structures match working examples")
    print("   4. ✅ State Machine embedded")

    print(f"\n🔧 Critical Fix (V78.2):")
    print("   - V78.1.6 PROBLEM: Used 'mode/rules' (Switch v3.4+ structure)")
    print("   - Root Cause: n8n 2.15.0 expects 'conditions' (Switch v3.0)")
    print("   - V78.2 FIX: Use 'conditions' structure from working examples")
    print("   - Result: Compatible with n8n 2.15.0")

    print(f"\n📝 Next Steps:")
    print("   1. Import 02_ai_agent_conversation_V78_2_FINAL.json")
    print("   2. Should import successfully (correct v3 structure)")
    print("   3. Test WF06 integration")

...
// ===================================================
// CRITICAL FIX: Include state fields in collected_data for database persistence
// - V104: Add current_stage, next_stage, previous_stage INSIDE collected_data object
// - This enables Build Update Queries to access state and update state_machine_state column
// - Fixes infinite loop where user gets stuck repeatedly selecting dates
// - Based on V101 WF06 Switch Execution Fix
...
// Date: 2026-04-27
// Version: V104 Database State Update Fix
// ===================================================
...
// V104: Enhanced logging for debugging
console.log('=== V104 STATE MACHINE START (DATABASE STATE UPDATE FIX) ===');
console.log('V104: conversation_id:', input.conversation_id || input.id || 'NULL');
console.log('V104: Current stage:', currentStage);
console.log('V104: Is intermediate state:', isIntermediateState);
...
// V104: Enhanced logging for state transitions
console.log('V104: Current → Next:', currentStage, '→', nextStage);
console.log('V104: Response length:', responseText.length);
console.log('V104: Update data keys:', Object.keys(output.collected_data));
console.log('V104: Preserved data in collected_data:');
console.log('V104:   lead_name:', output.collected_data.lead_name);
console.log('V104:   email:', output.collected_data.email);
console.log('V104:   phone_number:', output.collected_data.phone_number);
console.log('V104:   service_type:', output.collected_data.service_type);
console.log('V104:   service_selected:', output.collected_data.service_selected);
console.log('V104: ✅ CRITICAL FIX - State fields in collected_data:');
console.log('V104:   current_stage:', output.collected_data.current_stage);
console.log('V104:   next_stage:', output.collected_data.next_stage);
console.log('V104:   previous_stage:', output.collected_data.previous_stage);
console.log('V104: Output conversation_id:', output.conversation_id);
console.log('=== V104 STATE MACHINE END ===');

// ===================================================
// V107 STATE MACHINE - WF06 LOOP + UPSERT UNDEFINED FIX
// ===================================================
// CRITICAL FIX: Two production-blocking bugs fixed
// - V107 Part 1: WF06 loop prevention - detect awaiting_wf06_* flags BEFORE state resolution
// - V107 Part 2: Upsert undefined fix - requires manual n8n UI change (not in this script)
// - Based on V104 Database State Update Fix
// - V104: Include state fields in collected_data for database persistence
...
// Date: 2026-04-27
// Version: V107 WF06 Loop + Upsert Undefined Fix
// ===================================================
...
// V107: Enhanced logging for debugging
console.log('=== V107 STATE MACHINE START (WF06 LOOP + UPSERT UNDEFINED FIX) ===');
console.log('V107: conversation_id:', input.conversation_id || input.id || 'NULL');
console.log('V107: Current stage:', currentStage);
console.log('V107: Is intermediate state:', isIntermediateState);
console.log('V107: Forced stage from awaiting flag:', forcedStage);
console.log('V104: User message:', message);
console.log('V104: Merged currentData keys:', Object.keys(currentData));
console.log('V104: Preserved lead_name:', currentData.lead_name);
console.log('V104: Preserved email:', currentData.email);
console.log('V104: Preserved phone_number:', currentData.phone_number);
console.log('V104: Preserved service_type:', currentData.service_type);
console.log('V104: Preserved service_selected:', currentData.service_selected);
console.log('V104: Input keys:', Object.keys(input));
...
console.log('V104: Has WF06 response:', hasWF06Response);
if (hasWF06NextDates) console.log('V104: Has next_dates data');
if (hasWF06Slots) console.log('V104: Has available_slots data');
...
// ===================================================
// V104 CRITICAL: Build output with data preservation + state in collected_data
// ===================================================
const output = {
...
// V107: Enhanced logging for state transitions
console.log('V107: Current → Next:', currentStage, '→', nextStage);
console.log('V107: Response length:', responseText.length);
console.log('V107: Update data keys:', Object.keys(output.collected_data));
console.log('V107: Preserved data in collected_data:');
console.log('V107:   lead_name:', output.collected_data.lead_name);
console.log('V107:   email:', output.collected_data.email);
console.log('V107:   phone_number:', output.collected_data.phone_number);
console.log('V107:   service_type:', output.collected_data.service_type);
console.log('V107:   service_selected:', output.collected_data.service_selected);
console.log('V107: ✅ CRITICAL FIX - State fields in collected_data:');
console.log('V107:   current_stage:', output.collected_data.current_stage);
console.log('V107:   next_stage:', output.collected_data.next_stage);
console.log('V107:   previous_stage:', output.collected_data.previous_stage);
console.log('V107: ✅ WF06 LOOP FIX - awaiting flags cleared:', !currentData.awaiting_wf06_next_dates && !currentData.awaiting_wf06_available_slots);
console.log('V107: Output conversation_id:', output.conversation_id);
console.log('=== V107 STATE MACHINE END ===');
